...
const generateFile = async (fileName: string,
  ...
  const submissionPeriod = options?.submissionPeriod ?? await getUniqueSubmissionPeriod(office, AREA_OF_LAW);
