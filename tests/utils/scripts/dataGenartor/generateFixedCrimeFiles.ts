...
export async function GenerateFixedCrimePoliceFile(
    ...
    content +=
        ...
        `TRAVEL_WAITING_COSTS=10,WORK_CONCLUDED_DATE=26/01/2020,NO_OF_SUSPECTS=2,NO_OF_POLICE_STATION=1,POLICE_STATION=RD016,DUTY_SOLICITOR=Y,` +
    ...
    content +=
        ...
        `PROFIT_COST=56.43,DISBURSEMENTS_AMOUNT=5000,DISBURSEMENTS_VAT=0.73,VAT_INDICATOR=Y,TRAVEL_COSTS=82.2,OUTCOME_CODE=CN02,CRIME_MATTER_TYPE=01,` +
        `TRAVEL_WAITING_COSTS=29.22,WORK_CONCLUDED_DATE=06/09/2018,NO_OF_SUSPECTS=3,NO_OF_POLICE_STATION=1,POLICE_STATION=NE001,DUTY_SOLICITOR=Y,` +
